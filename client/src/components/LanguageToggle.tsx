  ...
  return (
    <div className="relative">
      <button
        ...
        className="nf-button inline-flex items-center gap-1.5 border border-white/15 px-2.5 py-2 text-[10px] font-semibold tracking-[.07em] text-[#cbd3ce] hover:border-white/45 hover:text-white"
      >
