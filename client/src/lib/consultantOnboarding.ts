...
export const emptyWarmInterviewDraft: WarmInterviewDraft = { preferredName: "", contactEmail: "", studyDirection: "", studyLevel: "", tuitionBudgetBand: "unsure", fundingRoute: "unsure", hasSponsor: false, nationality: "", academicAverage: "", gradeScale: "", highSchoolDiplomaOrigin: "", languageComfort: "", priorities: "", phoneNumber: "", consent: false };
