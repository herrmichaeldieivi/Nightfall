...
const labels = {
  ...
  ar: { tools: "أدواتي", close: "إغلاق", fallback: "نايتفول رجّعتك للخطوة اللي بتخلي هالأداة مفيدة بالأول.", tab: { consult: "المستشار", discover: "استكشف خيارات", compare: "قارن", reach: "تواصل مع الجامعة", calendar: "المواعيد", watch: "مراقبة المصادر", documents: "الأوراق" } },
} as const;
...
export default function JourneyTools() {
  ...
  // (stage === "orient", or remainingConsultations > 0) — it is a bounded, permanent
